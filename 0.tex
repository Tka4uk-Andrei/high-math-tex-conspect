...
\begin{document}
    ...
    \include{2_9}  %13  %OK  Q
    \include{2_10} %14  %OK
    \include{2_11} %15  %OK  Q
    \include{2_12} %16  %OK  Q
    \include{2_13} %16  %OK  Q
    \include{2_14} %17  %OK  Q
    \include{2_15} %18  %OK  Q
    \include{2_16} %19  %ОК
    \include{2_17} %19  %ReWriting
    
    \include{3_1}  %20  %ReWriting
    \include{3_2}  %21  %Writing
    \include{3_3}  %20  %ReWriting
    
    \include{4_1}  %21  %ReWriting
    \include{4_2}  %21  %ReWriting
    \include{4_3}  %21  %ReWriting
    \include{4_4}  %26  %ReWriting
    
    \include{5_1}  %28  %ReWriting
    \include{5_2}  %29  %ReWriting
    \include{5_3}  %30  %ReWriting
    \include{5_4}  %31  %ReWriting
