...
\begin{Example}~\\
	\begin{figure}[h]
		\begin{minipage}[h]{0.55\linewidth}
			\center{\includegraphics[width=0.75\linewidth]{4_1_1.png} \\ $\text{Семейство }f_n(x)$}
		\end{minipage}
		\hfill
		\begin{minipage}[h]{0.55\linewidth}
			\center{\includegraphics[width=0.75\linewidth]{4_1_2.png} \\ $F(x)$}
		\end{minipage}
	\end{figure}\\
	$f_n(x) = x^n, x \in [0;1]$\\
...
\begin{Note}
	...
	\begin{figure}[h]
		\begin{minipage}[h]{0.3\linewidth}
			\center{\includegraphics[width=0.9\linewidth]{4_1_5.png}}
		\end{minipage}
		\hfill
